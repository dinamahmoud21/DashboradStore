...
export class SaleReportComponent implements OnInit {
 product!: Product[];
  ...
  @Input() productitem?: SaleBill;
  NewProduct:Product=new Product()

 dtTrigger: Subject<void> = new Subject<any>();
  dtOptions: DataTables.Settings = {};
  selectedItem:SaleBill |any={}
  date!: Date
   source: any;
  language:any= {
 ...
 getProduct(): void {
   ...
   return new Promise<any>((resolve) => {
    ...
    this.ProductSer.getSaleProductByMail(this.auth.userData.email).subscribe(product => {
          resolve(product)
    ...
    deleteproduct(item:any){
      ...
      Swal.fire({
        ...
        console.log(this.selectedItem.id)
          ...
          this.ProductSer.deleteSaleProduct(this.selectedItem.id).catch(error => console.log(error))
          
        this.selectedItem.SaleProduct?.forEach(
        async (el:any) => {
            ...
            data.forEach((element:any) => {
              ...
              console.log(this.NewProduct)
                ...
                const data = {
                  ...
                  saleMount: Number(this.NewProduct.BuyMount) +Number(el.mount),
