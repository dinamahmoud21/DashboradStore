...
export class ExportDetailsComponent implements OnInit {
 ...
 Expert:  Experter | any = new Experter()
  ...
  ngAfterContentInit() {
    ...
    this.productSer.getExpertById(this.id).subscribe(result => {
      this.Expert = result
      console.log(this.Expert)
      this.filterByExpertName(this.Expert.ExpertName)
    }
 ...
 async  filterByExpertName(Expertname:string) {
   this.product = await this.productSer.filterByExperet(Expertname)
